...
Run the code with the **Run** button as usual, you'll see the distance in the output of your app in the terminal. Hold your hand in front of the sensor and see how the value changes. Pretty cool. No more bumping into stuff.
...
== Set Up Your Development Environment to show the images
