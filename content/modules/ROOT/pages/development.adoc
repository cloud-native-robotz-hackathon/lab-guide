...
TIP: Some Browers will ask you wether to allow pasting text. Approve this to proceed.
...
Now let the robot drive forward, look left and right and then retreat again. And for the fun of it, let it get the distance and print it out.
...
To become more familiar with the robot controls (and have some more fun), here are two challenges for you. Use your new robot skills and change the application to win the challenges:

**First Challenge**

Create code to simply guide your robot around the barrier. Just use the movement commands, approximate the distances and try to get your robot around the obstacle as good as possible.

**Second Challenge**

Imagine something is blocking your robots path! Your mission is now to drive straight towards a barrier as fast as possible but of course not crashing into it.

That means you will need to create loop of driving and checking the distance.  You can create this more prudent or more risky. Try different distances by moving the robot nearer or farther away from the barrier.
