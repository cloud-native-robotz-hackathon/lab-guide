...
To become more familiar with the robot controls (and have some more fun), here is a task for you:

Imagine something is blocking your robots path! Your mission is now to drive towards a barrier as fast as possible but of course not crashing into it.

That means you will need to create loop of driving and checking the distance.  You can create this more prudent or more risky. You will not know how close to the barrier your robot will start.  This is all about driving forward. No need for turns.

=== Stopping works?

Then move on and try to navigate the robot around the obstacle.
