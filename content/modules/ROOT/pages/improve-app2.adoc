...
Congratulations if you have made it this far. our have deployed your solution all the way to the edge on the robot.

But right now we have only used the camera of the robot to check for hats, but in a more complex and dangerous environment we don't want our little guy bumping into things. We want to detect obstacles and avoid them.
