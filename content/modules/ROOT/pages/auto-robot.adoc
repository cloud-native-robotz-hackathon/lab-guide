...
After your control application performs well enough, it's time to move on to the final stage of the hackathon: Have the robot run autonomously and measure the time it takes to accomplish the mission laid out in challenge 2! 
