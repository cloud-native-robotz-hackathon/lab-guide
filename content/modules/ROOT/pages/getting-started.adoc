...
Here are the steps you have do go through in order to work on the robot challenges:

* Setup the coding environment
* Clone example code
* Connect the application to your robot, the robot will be assigned by the challenge supporters 
