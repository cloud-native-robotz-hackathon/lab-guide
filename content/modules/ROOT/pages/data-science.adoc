...
This will show you a view of our Data Science Pipeline. This pipeline runs several steps / Python scripts in sequence to train our model. Again you don't have chnage anything here but feel to have a look at the thse steps by clicking on them.
