...
- Close the Welcome to OpenShift AI dialog  
+
image::welcome-to-openshift-3.5.png[width=350]

- In the left menu click on **Projects** to see all available Projects
+
image::rhoai-projects-menu.png[width=350]
...
*** link:_images/fedora-demo-image-1.jpg[fedora-demo-image-1.jpg,target=_blank]
*** link:_images/fedora-demo-image-2.jpg[fedora-demo-image-2.jpg,target=_blank]
...
+
image::label-studio-export.png[]

* and as format choose `YOLO with Images`.
* Click **Export**
...
* open the folder `object-detection-training-pvc/custom_training_images/fedora/`
+
image::workbench-upload-1.png[]

* Open the `images` folder
** upload your images using the **Upload Files** button.
** Select the all images in the `images` folder of the zip file.

* Open the `labels` folder
** upload your label files using the **Upload Files** button.
** Select the all label files in the `labels` folder of the zip file.
...
* Switch to the *Red Hat OpenShift AI* tab in your browser
* Select your Project {user}-ai
...
* Click on **Projects** in the main menu on the left and make sure you have selected your `{user}-ai` again
